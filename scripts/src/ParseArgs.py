...
class ParseCommand(object):
    ...
    def IteraBatchparse(self):
        ...
        parser = argparse.ArgumentParser(prog="IterationBatch.py",
        ...
        parser.add_argument('genomedir',
                            help="String, genomic data folder.",
                            )
    ...
    def identifyparse(self):
        ...
        # positional arguments
        parser.add_argument('hitPROfile',
                            help="IdentityFunc.py script output file(protein sequence file). \
                                 hit sequence from genome"
                            )
        parser.add_argument('hitDNAfile',
                            help="IdentityFunc.py script output file(DNA sequence file). \
                                 hit sequence from genome"
                            )
